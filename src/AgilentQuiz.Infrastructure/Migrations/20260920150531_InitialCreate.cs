        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BanExpiryTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_InstrumentTypes_InstrumentTypeId",
                        column: x => x.InstrumentTypeId,
                        principalTable: "InstrumentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationItems_Instruments_InstrumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Instruments_TypeStatus",
                table: "Instruments",
                columns: new[] { "InstrumentTypeId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_StatusRetry",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationItems_InstrumentStatus",
                table: "ReservationItems",
                columns: new[] { "InstrumentId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_PhoneStatus",
                table: "Reservations",
                columns: new[] { "Phone", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_TypeStatusTime",
                table: "Reservations",
                columns: new[] { "InstrumentTypeId", "Status", "StartTime", "EndTime" });
